...
class Deliveredtestreportview extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      data: {},
            ...
            <Row className="m-2">
              <Col>
                <h1 col-sm-6 className="float-left">
                  View Delivered Test Report

                </h1>
              </Col>
              <Col>
              <Link to={'/Dianostics-management/Delivered-test-report'}>
                <Button
...
export default Deliveredtestreportview
