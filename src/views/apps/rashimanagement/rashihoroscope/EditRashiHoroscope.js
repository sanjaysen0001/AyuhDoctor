...
export class EditRashiHoro extends Component {
    ...
    axiosConfig
      ...
      .then((response) => {
        ...
        this.setState({
          ...
          sort_desc: response.data.data.sort_desc,
          long_desc: response.data.data.long_desc,
          rashiId: response.data.data.rashiId,
        });
      })
      .catch((error) => {
        console.log(error);
  ...
  render() {
    return (
      <div>
        <Breadcrumbs
          breadCrumbTitle="Edit Rashi Horoscope"
          breadCrumbParent=" Rashi Horoscope Mangement"
