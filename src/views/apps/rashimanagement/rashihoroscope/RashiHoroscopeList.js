              ...
              <Route
                render={({ history }) => (
                  <Eye
                    ...
                    onClick={() =>
                      history.push(
                        `/app/rashimanagement/rashihoroscope/viewRashiHoroscope/${params.data._id}`
                      )
                    }
                  />
                )}
              ...
              <Route
                render={({ history }) => (
                  <Edit
                    ...
                    onClick={() =>
                      history.push(
                        `/app/rashimanagement/rashihoroscope/editRashiHoroscope/${params.data._id}`
                      )
                    }
                  />
                )}
      ...
      (
        <div>
          <Breadcrumbs
            ...
            breadCrumbActive="Rashi Horoscope List"
          />
                    ...
                    <Route
                      render={({ history }) => (
                        <Button
                          ...
                          onClick={() =>
                            history.push(
                              "/app/rashimanagement/rashihoroscope/addRashiHoroscope"
                            )
                          }
                        >
                          Add Horoscope
